        ...
        <div class="form-group">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-3">
              <input type="text" name="comp_add_no" id="comp_add_no" class="form-control" />
            </div>
            <div class="form-group col-md-3">
              <input type="text" name="comp_add_street1" id="comp_add_street1" placeholder="Address1" class="form-control" />
            </div>
            <div class="form-group col-md-3">
              <input type="text" name="comp_add_street2" id="comp_add_street2" placeholder="Address2*" class="form-control" />
            </div>
            <div class="form-group col-md-3">
              <input type="text" name="comp_add_city" id="comp_add_city" placeholder="City" class="form-control" />
            </div>
          </div>
        </div>
